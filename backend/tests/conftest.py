...
def isolated_data_dir(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
	...
	monkeypatch.setattr(settings, "TRUSTED_PROXY_AUTH_ALLOWED_EMAILS", "")
	monkeypatch.setattr(settings, "TRUSTED_PROXY_AUTH_HEADER_EMAIL", "Tailscale-User-Login")
	monkeypatch.setattr(settings, "TRUSTED_PROXY_AUTH_HEADER_NAME", "Tailscale-User-Name")
