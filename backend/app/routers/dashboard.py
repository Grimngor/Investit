...
async def get_kpis(current_user: User = Depends(get_current_user)) -> Dict[str, Any]:
    ...
    Returns:
        ...
        - current_value: Sum of (shares × latest_price) for all positions
    ...
    # Calculate total invested from finalized orders
    total_invested = sum(float(o.get("amount_eur", 0)) for o in finalized_orders)
